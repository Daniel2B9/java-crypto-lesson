...
public class Transaction {
    ...
    private String createHash() {
        ...
        return Utils.applySha256(Utils.getStringFromKey(sender) + Utils.getStringFromKey(reciepient) + value + sequence);
    }

    public void generateSignature(PrivateKey privateKey) {
        String data = Utils.getStringFromKey(sender) + Utils.getStringFromKey(reciepient) + value;
    ...
    public boolean processTransaction() {
        ...
        for (TransactionOutput o :
             outputs) {
            Main.UTXOs.put(o.id, o);
        }

        for (TransactionInput i:
             inputs) {
